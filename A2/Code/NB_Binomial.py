...
class NB_Binominal():
    ...
    def RunBody(self):
        ...
        for i in range( foldNum):
            ...
            alpha_zero = self.GetTrainingAlpha(1)
            alpha_1st = self.GetTrainingAlpha(2)
            ...
            alpha_base_0 = self.GetTrainingAlpaBaseOn( 1, class_0_Num)
            alpha_base_1 = self.GetTrainingAlpaBaseOn( 2, class_1_Num)
...
#             print "Testing", self.testingX
            ...
            for i in range( len( self.testingY)):
                ...
                if int(self.testingY[i]) == 1:
                    if (g0-g1)>= 0:
                        TP += 1
                    else:
                        FN += 1
                elif int(self.testingY[i]) == 2:
                    if (g1-g0)>= 0:
                        TN += 1
                    else:
                        FP += 1
